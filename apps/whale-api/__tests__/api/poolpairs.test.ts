...
import { ApiPagedResponse, WhaleApiClient, WhaleApiException, poolpairs } from '@defichain/whale-api-client'
...
describe('list', () => {
  it('should list', async () => {
    const response: ApiPagedResponse<poolpairs.PoolPairData> = await client.poolpairs.list(30)
...
describe('get', () => {
  it('should get 9', async () => {
    const response: poolpairs.PoolPairData = await client.poolpairs.get('9')
  ...
  it('should get 20', async () => {
    const response: poolpairs.PoolPairData = await client.poolpairs.get('20')
